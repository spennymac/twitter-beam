package com.compulsivesoftware.twitterbeam.bigquery;
...
/**
 * The {@link JsonToTableRow} transform converts JSON strings to {@link TableRow} objects.
 */
@AutoValue
public abstract class JsonToTableRow
        extends PTransform<PCollection<String>, PCollectionTuple> {

    public static Builder newBuilder() {
        return new AutoValue_JsonToTableRow.Builder();
    }
    ...
    public abstract TupleTag<String> failureTag();

    @Override
    public PCollectionTuple expand(PCollection<String> jsonElements) {
        return jsonElements.apply(
                "JsonToTableRow",
                ParDo.of(
    ...
    /**
     * Builder for {@link JsonToTableRow}.
     */
    @AutoValue.Builder
